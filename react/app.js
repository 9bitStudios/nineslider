...
var _Nineslider = __webpack_require__(8);
...
var Nineslider = exports.Nineslider = function (_React$Component) {
    _inherits(Nineslider, _React$Component);

    function Nineslider() {
        _classCallCheck(this, Nineslider);
    ...
    _createClass(Nineslider, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                { 'class': 'nbs-nineslider-container' },
                React.createElement(
                    'ul',
...
var Slide = exports.Slide = function (_React$Component) {
    ...
    function Slide() {
        ...
        _this.activeSlideStyle = {
            display: "block",
            position: "relative",
            zIndex: 2
        };

        _this.inactiveSlideStyle = {
            display: "none",
            zIndex: 1
        };

        _this.nextSlideStyle = {
            display: "block",
            position: "absolute",
            zIndex: 1
        };
        ...
        _this.state = {
            ...
            style: _this.props.isCurrentSlide ? _this.activeSlideStyle : _this.inactiveSlideStyle
        };
        return _this;
    }
...
exports.NavigationItem = undefined;
...
var NavigationItem = exports.NavigationItem = function (_React$Component) {
    _inherits(NavigationItem, _React$Component);

    function NavigationItem() {
        _classCallCheck(this, NavigationItem);

        var _this = _possibleConstructorReturn(this, (NavigationItem.__proto__ || Object.getPrototypeOf(NavigationItem)).apply(this, arguments));
    ...
    _createClass(NavigationItem, [{
        ...
        value: function render() {
            ...
            var directionClass = "nbs-nineslider-nav-" + this.props.direction;
            return React.createElement("div", { className: directionClass, onClick: function onClick() {
                    return _this2.itemClick();
                } });
        }
    }]);
...
var PagingItem = exports.PagingItem = function (_React$Component) {
    _inherits(PagingItem, _React$Component);

    function PagingItem() {
        _classCallCheck(this, PagingItem);

        var _this = _possibleConstructorReturn(this, (PagingItem.__proto__ || Object.getPrototypeOf(PagingItem)).apply(this, arguments));
    ...
    _createClass(PagingItem, [{
        key: "pagingClick",
        value: function pagingClick(e) {
            var _this2 = this;
        ...
        value: function render() {
            ...
            return React.createElement("li", { className: isActive, onClick: function onClick() {
                    return _this3.pagingClick();
                } });
        }
    }]);
